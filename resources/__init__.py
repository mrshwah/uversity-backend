...
from .courses import Course, CourseList, CourseEnroll, PublishCourse
...
def init_app(app):
    ...
    api.add_resource(PublishCourse, '/course/<string:course_id>/publish')
    api.add_resource(CategoryList, '/categories')
    api.add_resource(Aggregates, '/instructor/aggregates/<string:instructor_id>')
